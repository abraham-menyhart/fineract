...
public class LoanAccountOwnerTransferServiceTest {
    ...
    public void givenLoanTwoTransferSameDay() {
        ...
        // when
        underTest.handleSameDaySaleAndBuyback(actualDate, response, loanForProcessing);
        // then
    ...
    public void givenLoanBuyback() {
        ...
        // when
        underTest.handleBuyback(loanForProcessing, actualDate, firstResponseItem);
        // then
        verify(firstResponseItem).setEffectiveDateTo(actualDate);
    ...
    public void givenLoanSale() {
        ...
        // when
        underTest.handleSale(loanForProcessing, actualDate, firstResponseItem);
        // then
        verify(firstResponseItem).setEffectiveDateTo(actualDate);
        verify(externalAssetOwnerTransferRepository, times(2)).save(externalAssetOwnerTransferArgumentCaptor.capture());
